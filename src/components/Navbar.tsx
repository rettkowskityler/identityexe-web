  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <a href="/" className="flex items-center justify-center no-underline group">
          <img src="/logo.svg" alt="IdentityEXE Logo" className="h-8 md:h-10 w-auto transition-all duration-300 group-hover:drop-shadow-[0_0_12px_rgba(59,130,246,0.6)] group-hover:brightness-110" />
        </a>
      ...
      >
        <div className="flex flex-col items-center gap-6 px-6">
          ...
          <a 
            href="/contact" 
            onClick={() => setMobileMenuOpen(false)}
            className="w-full text-center bg-brand-blue hover:bg-brand-accent text-white font-black text-sm px-6 py-4 rounded-full uppercase tracking-widest shadow-[0_0_15px_rgba(81,132,196,0.4)] border border-white/10 hover:shadow-[0_0_25px_rgba(84,199,231,0.6)] active:scale-95 transition-all duration-300 btn-shimmer"
          >
            Talk to an Expert
          </a>
        </div>
