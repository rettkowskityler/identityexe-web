...
export default function MaintenanceModePost() {
  const tocItems = [
    ...
    { id: 'monitoring-audit', label: 'Monitoring & Audit' },
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
          ...
          <article className="lg:col-span-3 min-w-0 w-full overflow-hidden glass-card rounded-2xl sm:rounded-3xl p-5 sm:p-8 md:p-12 animate-fade-in-up">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-6 leading-tight">
              ...
              <span className="text-brand-blue text-2xl md:text-3xl">(Custom Workflow Forms Solution)</span>
            </h1>
          ...
          <div className="prose prose-invert break-words w-full overflow-x-hidden prose-pre:max-w-[85vw] sm:prose-pre:max-w-full prose-pre:overflow-x-auto prose-img:max-w-full prose-img:h-auto prose-base md:prose-lg max-w-none prose-headings:font-black prose-headings:tracking-tight prose-a:text-brand-accent hover:prose-a:text-brand-light prose-code:text-brand-light prose-code:bg-brand-blue/20 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded-md">
            ...
            <div className="bg-slate-900/50 border border-white/5 rounded-xl p-6 mb-8">
              ...
              <ul className="list-disc pl-5 text-slate-300 space-y-2 mb-6">
                <li>Enable / Disable - Dropdown Field</li>
                <li>Source Selector - Predefined Sources Dropdown Field</li>
            ...
            <h3 id="back-end" className="text-2xl text-white mt-12 mb-4">Back End</h3>
            <ul className="space-y-3 text-slate-300 mb-8 list-disc pl-5">
            ...
            <h3 id="api-calls" className="text-2xl text-white mt-12 mb-4">API Calls</h3>
            
            <h4 className="text-xl text-brand-accent mt-6 mb-3">Enable Maintenance Mode API Calls</h4>
            <ul className="space-y-2 text-slate-300 mb-4 list-none pl-0">
              <li className="font-mono text-sm break-all"><span className="text-green-400 mr-2">GET</span> <strong className="text-white">Source by ID</strong> - /v2026/sources/{'{'}{'{'}$.interactiveForm.formData.sources{'}'}{'}'}</li>
              <li className="font-mono text-sm break-all"><span className="text-green-400 mr-2">GET</span> <strong className="text-white">Group Aggregation Schedule</strong> - /v2026/sources/{'{'}{'{'}$.interactiveForm.formData.sources{'}'}{'}'}/schedules/GROUP_AGGREGATION</li>
              <li className="font-mono text-sm break-all"><span className="text-green-400 mr-2">GET</span> <strong className="text-white">Account Aggregation Schedule</strong> - /v2026/sources/{'{'}{'{'}$.interactiveForm.formData.sources{'}'}{'}'}/schedules/ACCOUNT_AGGREGATION</li>
              <li className="font-mono text-sm break-all"><span className="text-red-400 mr-2">DELETE</span> <strong className="text-white">Current Group Aggregation Schedule</strong> - /v2026/sources/{'{'}{'{'}$.interactiveForm.formData.sources{'}'}{'}'}/schedules/GROUP_AGGREGATION</li>
              <li className="font-mono text-sm break-all"><span className="text-red-400 mr-2">DELETE</span> <strong className="text-white">Current Account Aggregation Schedule</strong> - /v2026/sources/{'{'}{'{'}$.interactiveForm.formData.sources{'}'}{'}'}/schedules/ACCOUNT_AGGREGATION</li>
              <li className="font-mono text-sm break-all"><span className="text-yellow-400 mr-2">PATCH</span> <strong className="text-white">Source Connector Attributes</strong> - /v2026/sources/{'{'}{'{'}$.interactiveForm.formData.sources{'}'}{'}'}</li>
            </ul>
...
<pre className="text-sm text-slate-300 m-0"><code>{`[
  ...
  { "op": "add", "path": "/connectorAttributes/maintenancemode", "value": true }
            ...
            <h4 className="text-xl text-brand-accent mt-6 mb-3">Disable Maintenance Mode API Calls</h4>
            <ul className="space-y-2 text-slate-300 mb-4 list-none pl-0">
              <li className="font-mono text-sm break-all"><span className="text-green-400 mr-2">GET</span> <strong className="text-white">Source by ID</strong> - /v2026/sources/{'{'}{'{'}$.interactiveForm.formData.sources{'}'}{'}'}</li>
              <li className="font-mono text-sm break-all"><span className="text-yellow-400 mr-2">PATCH</span> <strong className="text-white">Source by ID</strong> - /v2026/sources/{'{'}{'{'}$.interactiveForm.formData.sources{'}'}{'}'}</li>
              <li className="font-mono text-sm break-all"><span className="text-brand-accent mr-2">POST</span> <strong className="text-white">Group Aggregation Schedule</strong> - /v2026/sources/{'{'}{'{'}$.interactiveForm.formData.sources{'}'}{'}'}/schedules</li>
              <li className="font-mono text-sm break-all"><span className="text-brand-accent mr-2">POST</span> <strong className="text-white">Account Aggregation Schedule</strong> - /v2026/sources/{'{'}{'{'}$.interactiveForm.formData.sources{'}'}{'}'}/schedules</li>
              <li className="font-mono text-sm break-all"><span className="text-yellow-400 mr-2">PATCH</span> <strong className="text-white">Source Connector Attributes</strong> - /v2026/sources/{'{'}{'{'}$.interactiveForm.formData.sources{'}'}{'}'}</li>
            </ul>
            <div className="bg-[#0d1117] rounded-lg p-4 overflow-x-auto mb-8 border border-white/10">
<pre className="text-sm text-slate-300 m-0"><code>{`[
  ...
  { "op": "add", "path": "/connectorAttributes/maintenancemode", "value": false }
            ...
            <h3 id="monitoring-audit" className="text-2xl text-white mt-12 mb-4">Monitoring & Audit</h3>
            <ul className="space-y-3 text-slate-300 mb-6 list-disc pl-5">
              ...
              <li><strong className="text-white">Functionality:</strong> The script queries the <code>/sources</code> endpoint to grab all the sources in the tenant with the connectorAttribute <code>maintenancemode</code> == true. It exports a list of all the sources that contain that flag and puts them into a CSV file with the current date & time. In my environment, it currently runs as a scheduled task on a windows server, but you can modify it to fit your org's needs.</li>
