...
export default function Blog() {
  ...
  const blogPosts: BlogPost[] = [
    ...
    {
      slug: 'aggregation-exporter-importer',
      title: 'Automating Aggregation Schedules: A Complete Exporter & Importer',
      category: 'Architecture',
      date: 'August 2026',
      description: 'A comprehensive, self-serve Toolkit utilizing SailPoint Workflows and PAG to give administrators granular, push-button control over their aggregation schedules tenant-wide.',
      iconBgClass: 'bg-blue-500/10',
      iconBorderClass: 'border-blue-500/20',
      iconColorClass: 'text-blue-400',
      hoverTitleClass: 'group-hover:text-blue-400',
      readMoreColorClass: 'text-blue-500',
      gradientClass: 'from-blue-600/20 to-indigo-600/20',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 opacity-80" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      ...
      category: 'Architecture',
      date: 'July 2026',
      description: 'A modular implementation framework designed to empower business owners to securely manage their assigned roles without administrative bottlenecks.',
